...
- CONFIRMED: RtG save files are represented as a top-level JSON Array where each element is a 3-element tuple: `[Type, Connections, Properties]`.
...
- CONFIRMED: The second element `Connections` is an array of 3-element connection tuples: `[TipoLocal, PuntoPadre, ÍndicePadre]`.
