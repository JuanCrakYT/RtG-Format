# Block: SuperPowerClock

## Identification
- **Name**: SuperPowerClock
- **Identifier**: `SuperPowerClock`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/SuperPowerClock/SuperPowerClock.obj`
- **Tooltip**: Change the time, and then activate it to lock the time!
- **Default Scale**: 1
...
*Source: `assets/models/model/SuperPowerClock/SuperPowerClock.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/SuperPowerClock/SuperPowerClock.json`
- `assets/models/model/SuperPowerClock/SuperPowerClock.obj`
