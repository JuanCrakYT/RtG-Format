...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Radio/Radio.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Radio/Radio.json` → LocalPoints*
...
| Volume | number | Audio volume | 0-10 | CONFIRMED |
| Channel | number | Radio channel | 0-100 | CONFIRMED |
| CustomTrack | string | Custom audio track | SoundId | CONFIRMED |
...
## Source Evidence
- `assets/models/model/Radio/Radio.json`
- `assets/models/model/Radio/Radio.obj`
