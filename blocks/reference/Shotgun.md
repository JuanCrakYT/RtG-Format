...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Shotgun/Shotgun.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Shotgun/Shotgun.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Shotgun/Shotgun.json`
- `assets/models/model/Shotgun/Shotgun.obj`
