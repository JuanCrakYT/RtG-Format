...
- **Category**: Other
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Pie/Pie.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Pie/Pie.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Pie/Pie.json`
- `assets/models/model/Pie/Pie.obj`
