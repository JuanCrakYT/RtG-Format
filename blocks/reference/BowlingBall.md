...
## Identification
- **Name**: BowlingBall
- **Identifier**: `BowlingBall`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/BowlingBall/BowlingBall.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/BowlingBall/BowlingBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/BowlingBall/BowlingBall.json`
- `assets/models/model/BowlingBall/BowlingBall.obj`
