...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Camera/Camera.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Camera/Camera.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Camera/Camera.json`
- `assets/models/model/Camera/Camera.obj`
