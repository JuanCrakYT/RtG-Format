...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/BouncyBall/BouncyBall.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/BouncyBall/BouncyBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/BouncyBall/BouncyBall.json`
- `assets/models/model/BouncyBall/BouncyBall.obj`
