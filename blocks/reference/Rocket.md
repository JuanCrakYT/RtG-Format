...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Rocket/Rocket.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Rocket/Rocket.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Rocket/Rocket.json`
- `assets/models/model/Rocket/Rocket.obj`
