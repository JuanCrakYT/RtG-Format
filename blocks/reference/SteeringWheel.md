...
## Identification
- **Name**: SteeringWheel
- **Identifier**: `SteeringWheel`
- **Category**: Other
- **Model Available**: Yes
- **Model Path**: `assets/models/model/SteeringWheel/SteeringWheel.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/SteeringWheel/SteeringWheel.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/SteeringWheel/SteeringWheel.json`
- `assets/models/model/SteeringWheel/SteeringWheel.obj`
