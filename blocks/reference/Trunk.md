...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Trunk/Trunk.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Trunk/Trunk.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Trunk/Trunk.json`
- `assets/models/model/Trunk/Trunk.obj`
