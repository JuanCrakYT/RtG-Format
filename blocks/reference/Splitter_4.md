...
## Identification
- **Name**: Splitter_4
- **Identifier**: `Splitter_4`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Splitter_4/Splitter_4.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Splitter_4/Splitter_4.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Splitter_4/Splitter_4.json`
- `assets/models/model/Splitter_4/Splitter_4.obj`
