...
## Identification
- **Name**: LongStick
- **Identifier**: `LongStick`
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/LongStick/LongStick.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/LongStick/LongStick.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/LongStick/LongStick.json`
- `assets/models/model/LongStick/LongStick.obj`
