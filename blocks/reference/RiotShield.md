...
## Identification
- **Name**: RiotShield
- **Identifier**: `RiotShield`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/RiotShield/RiotShield.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/RiotShield/RiotShield.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/RiotShield/RiotShield.json`
- `assets/models/model/RiotShield/RiotShield.obj`
