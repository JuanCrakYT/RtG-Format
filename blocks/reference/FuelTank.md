...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/FuelTank/FuelTank.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/FuelTank/FuelTank.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/FuelTank/FuelTank.json`
- `assets/models/model/FuelTank/FuelTank.obj`
