...
## Identification
- **Name**: ShortStick
- **Identifier**: `ShortStick`
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/ShortStick/ShortStick.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/ShortStick/ShortStick.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/ShortStick/ShortStick.json`
- `assets/models/model/ShortStick/ShortStick.obj`
