...
## Identification
- **Name**: BeachBall
- **Identifier**: `BeachBall`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/BeachBall/BeachBall.obj`
- **Tooltip**: It's fun. It's fun. It's fun.
- **Default Scale**: 1
...
*Source: `assets/models/model/BeachBall/BeachBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/BeachBall/BeachBall.json`
- `assets/models/model/BeachBall/BeachBall.obj`
