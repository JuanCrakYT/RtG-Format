...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/DoorC/DoorC.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/DoorC/DoorC.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/DoorC/DoorC.json`
- `assets/models/model/DoorC/DoorC.obj`
