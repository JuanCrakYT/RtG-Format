...
## Identification
- **Name**: SteeringGyro
- **Identifier**: `SteeringGyro`
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/SteeringGyro/SteeringGyro.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/SteeringGyro/SteeringGyro.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/SteeringGyro/SteeringGyro.json`
- `assets/models/model/SteeringGyro/SteeringGyro.obj`
