...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Uzi/Uzi.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Uzi/Uzi.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Uzi/Uzi.json`
- `assets/models/model/Uzi/Uzi.obj`
