...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Pipes/Pipes.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Pipes/Pipes.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Pipes/Pipes.json`
- `assets/models/model/Pipes/Pipes.obj`
