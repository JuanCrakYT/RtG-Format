...
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Connector/Connector.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Connector/Connector.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Connector/Connector.json`
- `assets/models/model/Connector/Connector.obj`
