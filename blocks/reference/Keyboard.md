...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Keyboard/Keyboard.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Keyboard/Keyboard.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Keyboard/Keyboard.json`
- `assets/models/model/Keyboard/Keyboard.obj`
