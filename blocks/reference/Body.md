...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Body/Body.obj`
- **Tooltip**: let the these hit the FLOOOOOOOOOOOOOOOR
- **Default Scale**: 1
...
*Source: `assets/models/model/Body/Body.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Body/Body.json`
- `assets/models/model/Body/Body.obj`
