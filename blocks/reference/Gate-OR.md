...
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Gate-OR/Gate-OR.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Gate-OR/Gate-OR.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Gate-OR/Gate-OR.json`
- `assets/models/model/Gate-OR/Gate-OR.obj`
