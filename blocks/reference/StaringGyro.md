...
## Identification
- **Name**: StaringGyro
- **Identifier**: `StaringGyro`
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/StaringGyro/StaringGyro.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/StaringGyro/StaringGyro.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/StaringGyro/StaringGyro.json`
- `assets/models/model/StaringGyro/StaringGyro.obj`
