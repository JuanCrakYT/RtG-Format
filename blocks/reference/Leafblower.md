...
## Identification
- **Name**: Leafblower
- **Identifier**: `Leafblower`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Leafblower/Leafblower.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Leafblower/Leafblower.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Leafblower/Leafblower.json`
- `assets/models/model/Leafblower/Leafblower.obj`
