...
## Identification
- **Name**: PotatoEngine
- **Identifier**: `PotatoEngine`
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/PotatoEngine/PotatoEngine.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/PotatoEngine/PotatoEngine.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/PotatoEngine/PotatoEngine.json`
- `assets/models/model/PotatoEngine/PotatoEngine.obj`
