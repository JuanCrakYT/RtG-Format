...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Carrot/Carrot.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Carrot/Carrot.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Carrot/Carrot.json`
- `assets/models/model/Carrot/Carrot.obj`
