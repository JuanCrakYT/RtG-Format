# Block: GoldPotatoEngine

## Identification
- **Name**: GoldPotatoEngine
- **Identifier**: `GoldPotatoEngine`
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/GoldPotatoEngine/GoldPotatoEngine.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/GoldPotatoEngine/GoldPotatoEngine.json` → LocalPoints*
...
| Speed | number | Engine speed | 0-1000 | CONFIRMED |
...
## Source Evidence
- `assets/models/model/GoldPotatoEngine/GoldPotatoEngine.json`
- `assets/models/model/GoldPotatoEngine/GoldPotatoEngine.obj`
