...
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Propeller/Propeller.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Propeller/Propeller.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Propeller/Propeller.json`
- `assets/models/model/Propeller/Propeller.obj`
