...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Gun/Gun.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Gun/Gun.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Gun/Gun.json`
- `assets/models/model/Gun/Gun.obj`
