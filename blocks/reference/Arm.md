...
- **Category**: Other
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Arm/Arm.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Arm/Arm.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Arm/Arm.json`
- `assets/models/model/Arm/Arm.obj`
