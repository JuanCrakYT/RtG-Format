...
## Identification
- **Name**: Splitter_1
- **Identifier**: `Splitter_1`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Splitter_1/Splitter_1.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Splitter_1/Splitter_1.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Splitter_1/Splitter_1.json`
- `assets/models/model/Splitter_1/Splitter_1.obj`
