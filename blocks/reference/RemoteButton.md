...
## Identification
- **Name**: RemoteButton
- **Identifier**: `RemoteButton`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/RemoteButton/RemoteButton.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/RemoteButton/RemoteButton.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/RemoteButton/RemoteButton.json`
- `assets/models/model/RemoteButton/RemoteButton.obj`
