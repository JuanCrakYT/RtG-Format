...
## Identification
- **Name**: CannonBall
- **Identifier**: `CannonBall`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/CannonBall/CannonBall.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/CannonBall/CannonBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/CannonBall/CannonBall.json`
- `assets/models/model/CannonBall/CannonBall.obj`
