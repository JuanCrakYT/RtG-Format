...
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Gyro/Gyro.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Gyro/Gyro.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Gyro/Gyro.json`
- `assets/models/model/Gyro/Gyro.obj`
