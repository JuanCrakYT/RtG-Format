...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Stick/Stick.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Stick/Stick.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Stick/Stick.json`
- `assets/models/model/Stick/Stick.obj`
