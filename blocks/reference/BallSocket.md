...
## Identification
- **Name**: BallSocket
- **Identifier**: `BallSocket`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/BallSocket/BallSocket.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/BallSocket/BallSocket.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/BallSocket/BallSocket.json`
- `assets/models/model/BallSocket/BallSocket.obj`
