...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Leg/Leg.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Leg/Leg.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Leg/Leg.json`
- `assets/models/model/Leg/Leg.obj`
