# Block: HalfConnectorBall

## Identification
- **Name**: HalfConnectorBall
- **Identifier**: `HalfConnectorBall`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/HalfConnectorBall/HalfConnectorBall.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/HalfConnectorBall/HalfConnectorBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/HalfConnectorBall/HalfConnectorBall.json`
- `assets/models/model/HalfConnectorBall/HalfConnectorBall.obj`
