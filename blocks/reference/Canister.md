...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Canister/Canister.obj`
- **Tooltip**: A small container for holding liquids
- **Default Scale**: 1
...
*Source: `assets/models/model/Canister/Canister.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Canister/Canister.json`
- `assets/models/model/Canister/Canister.obj`
