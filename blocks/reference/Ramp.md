...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Ramp/Ramp.obj`
- **Tooltip**: For all your sick tricks.
- **Default Scale**: 1
...
*Source: `assets/models/model/Ramp/Ramp.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Ramp/Ramp.json`
- `assets/models/model/Ramp/Ramp.obj`
