...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/DoorB/DoorB.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/DoorB/DoorB.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/DoorB/DoorB.json`
- `assets/models/model/DoorB/DoorB.obj`
