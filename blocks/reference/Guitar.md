...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Guitar/Guitar.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Guitar/Guitar.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Guitar/Guitar.json`
- `assets/models/model/Guitar/Guitar.obj`
