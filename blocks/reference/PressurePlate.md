...
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/PressurePlate/PressurePlate.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/PressurePlate/PressurePlate.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/PressurePlate/PressurePlate.json`
- `assets/models/model/PressurePlate/PressurePlate.obj`
