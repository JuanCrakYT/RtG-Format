...
## Identification
- **Name**: Cinderblock
- **Identifier**: `Cinderblock`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Cinderblock/Cinderblock.obj`
- **Tooltip**: its heavy
- **Default Scale**: 1
...
*Source: `assets/models/model/Cinderblock/Cinderblock.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Cinderblock/Cinderblock.json`
- `assets/models/model/Cinderblock/Cinderblock.obj`
