...
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Recorder/Recorder.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Recorder/Recorder.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Recorder/Recorder.json`
- `assets/models/model/Recorder/Recorder.obj`
