...
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Button/Button.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Button/Button.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Button/Button.json`
- `assets/models/model/Button/Button.obj`
