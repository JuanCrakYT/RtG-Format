...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Googie/Googie.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Googie/Googie.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Googie/Googie.json`
- `assets/models/model/Googie/Googie.obj`
