...
- **Category**: Building
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Wheel/Wheel.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Wheel/Wheel.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Wheel/Wheel.json`
- `assets/models/model/Wheel/Wheel.obj`
