...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Briefcase/Briefcase.obj`
- **Tooltip**: Contains briefings. or poop
- **Default Scale**: 1
...
*Source: `assets/models/model/Briefcase/Briefcase.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Briefcase/Briefcase.json`
- `assets/models/model/Briefcase/Briefcase.obj`
