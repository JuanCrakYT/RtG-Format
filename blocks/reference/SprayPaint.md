...
## Identification
- **Name**: SprayPaint
- **Identifier**: `SprayPaint`
- **Category**: Miscellaneous
- **Model Available**: Yes
- **Model Path**: `assets/models/model/SprayPaint/SprayPaint.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/SprayPaint/SprayPaint.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/SprayPaint/SprayPaint.json`
- `assets/models/model/SprayPaint/SprayPaint.obj`
