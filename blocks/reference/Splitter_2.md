...
## Identification
- **Name**: Splitter_2
- **Identifier**: `Splitter_2`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Splitter_2/Splitter_2.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Splitter_2/Splitter_2.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Splitter_2/Splitter_2.json`
- `assets/models/model/Splitter_2/Splitter_2.obj`
