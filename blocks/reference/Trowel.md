...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Trowel/Trowel.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Trowel/Trowel.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Trowel/Trowel.json`
- `assets/models/model/Trowel/Trowel.obj`
