...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Bearing/Bearing.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Bearing/Bearing.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Bearing/Bearing.json`
- `assets/models/model/Bearing/Bearing.obj`
