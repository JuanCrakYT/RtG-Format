...
## Identification
- **Name**: ConnectorBall
- **Identifier**: `ConnectorBall`
- **Category**: Wiring
- **Model Available**: Yes
- **Model Path**: `assets/models/model/ConnectorBall/ConnectorBall.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/ConnectorBall/ConnectorBall.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/ConnectorBall/ConnectorBall.json`
- `assets/models/model/ConnectorBall/ConnectorBall.obj`
