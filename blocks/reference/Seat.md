...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Seat/Seat.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Seat/Seat.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/Seat/Seat.json`
- `assets/models/model/Seat/Seat.obj`
