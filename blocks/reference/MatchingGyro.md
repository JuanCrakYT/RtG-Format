...
## Identification
- **Name**: MatchingGyro
- **Identifier**: `MatchingGyro`
- **Category**: Physics
- **Model Available**: Yes
- **Model Path**: `assets/models/model/MatchingGyro/MatchingGyro.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/MatchingGyro/MatchingGyro.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/MatchingGyro/MatchingGyro.json`
- `assets/models/model/MatchingGyro/MatchingGyro.obj`
