...
- **Model Available**: Yes
- **Model Path**: `assets/models/model/Mag/Mag.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/Mag/Mag.json` → LocalPoints*
...
| Quantity | number | Ammo quantity | 0-100 | CONFIRMED |
| Bullets | number | Bullet type | 0-100 | CONFIRMED |
...
## Source Evidence
- `assets/models/model/Mag/Mag.json`
- `assets/models/model/Mag/Mag.obj`
