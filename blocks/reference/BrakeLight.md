...
## Identification
- **Name**: BrakeLight
- **Identifier**: `BrakeLight`
- **Category**: Other
- **Model Available**: Yes
- **Model Path**: `assets/models/model/BrakeLight/BrakeLight.obj`
- **Tooltip**: N/A
- **Default Scale**: 1
...
*Source: `assets/models/model/BrakeLight/BrakeLight.json` → LocalPoints*
...
## Source Evidence
- `assets/models/model/BrakeLight/BrakeLight.json`
- `assets/models/model/BrakeLight/BrakeLight.obj`
