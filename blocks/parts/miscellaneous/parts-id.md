# Miscellaneous Parts — Connection Point IDs
...
| --------------------- | ----- | ------- | ----------------------------------------------------------------------- | ------------------- | ------------------------------------------- |
| (listed historically) | Tooth | Unknown | Listed in the historical "Objetos sin puntos de conexión propios" list. | PARTIALLY CONFIRMED | old-files/obj_ids-spanish.md — objects list |

## Camera

| ID                    | Name   | Side    | Description                                                      | Status              | Source / Evidence                           |
| --------------------- | ------ | ------- | ---------------------------------------------------------------- | ------------------- | ------------------------------------------- |
| (listed historically) | Camera | Unknown | Listed historically among objects without own connection points. | PARTIALLY CONFIRMED | old-files/obj_ids-spanish.md — objects list |

## Category index (Miscellaneous)

Miscellaneous parts as per the wiki and historical file. Many of these are listed in the historical "no own connection points" list; we preserve that notation.
