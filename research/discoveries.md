...
Discovery: Top-level JSON array where each element is `[Type, Connections, Properties]`.
...
Discovery: Each connection is `[TipoLocal, PuntoPadre, ÍndicePadre]`. The third value is the index of the parent in the top-level array.
